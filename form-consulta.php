...
if(isset($_POST['email'])) {
    ...
    $email_subject = "SOLICITAÇÃO DE CONSULTA";
    ...
    $comments = $_POST['especialidade']; // required
    $birth = $_POST['nascimento']; // required
  ...
  if(strlen($comments) < 2) {
    $error_message .= 'A especialidade que preencheu não parece válido.<br />';
  }
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Data de Nascimento: ".clean_string($birth)."\n";
    $email_message .= "Especialidade: ".clean_string($comments)."\n";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.policlinicasantoantonio.com.br/');</script>";
